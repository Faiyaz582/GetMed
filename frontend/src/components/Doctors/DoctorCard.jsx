...
const DoctorCard = ({ doctor }) => {
    ...
    return (
        <div className='p-3 lg:p-5'>
            ...
            <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E]  flex items-center justify-center group hover:bg-cyan-600 hover:border-none'>
