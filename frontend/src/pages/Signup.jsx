    ...
    <section className="px-5 xl:px-0">
      <div className="max-w-[1170px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          { /*img box*/}
          <div className="hidden lg:block bg-teal-800 rounded-l-lg">
            ...
            <form onSubmit={submitHandler}>
              <div className="mb-5">
                <input
                  ...
                  className="w-full pr-4 py-3 border-b border-solid border-[#04220a61] focus:outline-non
              ...
              <div className="mb-5 flex items-center gap-3">
                {selectedFile && <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-teal-800
          ...
          <p className="mt-5 text-textColor text-center">
            Already have an account yet?
             <Link to='/login' className="text-teal-600 font-medium ml-1"> Sign In here</Link>
            </p>
