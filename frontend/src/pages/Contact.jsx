...
const Contact = () => {
  return <section>
    <div className='px-4 mx-auto max-w-screen-md'>
      ...
      <p className='mb-8 lg:mb-16 font-light text-center text_para'>Got any technical issue? Want to send feedback? Let us know.</p>
      <form action="#" className='space-y-8 '>
        ...
        <div className="sm:col-span-2">
          ...
          <textarea rows={6} type="text" id="message" placeholder='Leave your comment...' className='form_input mt-1' />
        </div>
