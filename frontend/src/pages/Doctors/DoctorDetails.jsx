          ...
          <div className='md:col-span-2'>
            <div className='flex items-center gap-5'>
              ...
              <div>
                ...
                <h3 className='text-headingColor text-[22px] leading-10 font-bold'>Muhibur Rahman</h3>
                ...
                <p className='text_para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>
                  Dr. Muhibur Rahman is a skilled surgeon renowned for his expertise in minimally invasive techniques and dedication to patient care.
                </p>
              </div>
            </div>
