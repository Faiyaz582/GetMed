...
import doctorImg from '../../assets/images/Doc2.png';
          ...
          <div className='md:col-span-2'>
            <div className='flex items-center gap-5'>
              ...
              <div>
                ...
                <h3 className='text-headingColor text-[22px] leading-10 font-bold'>Dr. Robert Bruce</h3>
                ...
                Dr. Robert Bruce  is a skilled surgeon renowned for his expertise in minimally invasive techniques and dedication to patient care.
                </p>
              </div>
            </div>
