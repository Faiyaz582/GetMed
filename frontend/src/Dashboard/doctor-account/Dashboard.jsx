...
import useGetProfile from '../../hooks/useFeychData.jsx';
import Tabs from './Tabs.jsx';
import starIcon from '../../assets/images/Star.png'
import DoctorAbout from './../../pages/Doctors/DoctorAbout.jsx';
import Profile from './Profile.jsx';
import Appoinments from './Appoinments.jsx';
...

        {
             ...
             <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]">
              ...
              <div className='lg:col-span-2'>
                {data.isApproved === 'pending' && (
                   <div className='flex p-4 mv-4 text-teal-900 bg-teal-100 rounded-lg'>
                     <svg
                        aria-hidden="true"
          ...
          {tab === 'overview' && <div>
            <div className='flex items-center gap-4 mb-10'>
              ...
              <div>
                <span className='bg-[#CCF0F3] text-[#234e52] py-1 px-4 lg:py-2 lg:px-6 rounded text-[12px]
          ...
          {tab === 'appointments' && <Appoinments appoinments={data.appoinments}/>}
