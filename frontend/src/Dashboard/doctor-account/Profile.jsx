            ...
            <form>
                ...
                <div className="mb-5">
                    <div className="grid grid-cols-3 gap-5 mb-[30px]">
                        ...
                        <div>
                            <p className="form_label">Booking Cost*</p>
                            <input
                                type="number"
                                placeholder="100"
                                name="ticketPrice"
                    ...
                    {FormData.qualifications?.map((item, index) => <div key={index}>
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-5">
                                ...
                                <div>
                                    <p className="form_label">Institution</p>
                                    <input
                                        type="text"
                                        name="university"
                ...
                <div className="mb-5">
                    ...
                    <button className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer">Add Experiences</button>
                </div>
                <div className="mb-5">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                                <div>
                                    ...
                                    <select
                                        ...
                                        value={item.day}
                                        className="form_input py-3.5"
                                        style={{ zIndex: 10, position: 'relative' }} // Added z-index
                                    >
                                        <option value="">Select</option>
                ...
                {FormData.photo && <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-teal-800
                ...
                <div className='relative w-[130px] h-[50px]'>
                  ...
                  <label
                    ...
                    className="absolute top-0 left-0 w-full h-full flex items-center px-[0.75rem] py-[0.
                      375rem] text-[15px] leading-6 overflow-hidden bg-[#21ac9746] text-headingColor 
                 ...
                 <div className="mt-7">
                    <button type="submit" onClick={updateProfileHandler} className="bg-[#364f49] text-white text-[18px] leading-[30px] w-full py-3 px-4 rounded-lg">Update profile</button></div>       
